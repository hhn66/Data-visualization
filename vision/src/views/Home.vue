    ...
    <div class="screen-container" :style="containerStyle">
      <header class="screen-header">
        <div>
          ...
          <img v-show="theme == 'chalk'" src="~@/static/img/header_border_dark.png" alt="" />
          <img v-show="theme != 'chalk'" src="~@/static/img/header_border_light.png" alt="" />
        </div>
        ...
        <div class="title-right">
          ...
          <img v-show="theme == 'chalk'" src="~@/static/img/qiehuan_dark.png" class="qiehuan" @click="handleChangeTheme" alt="切换主题" title="切换主题" />
          <img v-show="theme != 'chalk'" src="~@/static/img/qiehuan_light.png" class="qiehuan" @click="handleChangeTheme" alt="切换主题" title="切换主题" />
